...
import { Property, getPropertyById, properties } from '../../data/properties';

interface PropertyPageProps {
  property: Property;
}

const PropertyDetails = ({ property }: PropertyPageProps) => {
        ...
        <div className="bg-white border-b">
          <div className="container-max py-4">
            <nav className="flex items-center space-x-2 text-sm">
              ...
              <Link href="/properties" className="text-primary-600 hover:text-primary-700">Properties</Link>
              <span className="text-gray-400">/</span>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
                <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-6">
                  <div>
                    <h1 className="text-3xl font-bold text-secondary-800 mb-2">{property.title}</h1>
                    <p className="text-xl text-primary-600 font-semibold mb-2">{property.priceFormatted}</p>
                ...
                <div className="border-t pt-6">
                  ...
                  <p className="text-secondary-600 leading-relaxed">{property.description}</p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                <div className="bg-white rounded-xl shadow-lg p-8">
                  <h3 className="text-xl font-bold text-secondary-800 mb-4">Key Features</h3>
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-secondary-600">{property.area} {property.areaUnit}</span>
                    </div>
                    <div className="flex items-center">
                      <svg className="w-5 h-5 text-primary-600 mr-2" fill="currentColor" viewBox="0 0 20 20">
                      ...
                      <span className="text-secondary-600">{property.parking} Parking</span>
                    </div>
                  </div>
                </div>

                <div className="bg-white rounded-xl shadow-lg p-8">
                  <h3 className="text-xl font-bold text-secondary-800 mb-4">Amenities</h3>
              ...
              {/* Nearby Facilities */}
              <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
                <h3 className="text-xl font-bold text-secondary-800 mb-4">Nearby Facilities</h3>
                <div className="grid md:grid-cols-2 gap-4">
                  {property.nearbyFacilities.map((facility, index) => (
                    <div key={index} className="flex items-center">
                      ...
                      <span className="text-secondary-600">{facility}</span>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="lg:col-span-1">
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 mb-8 sticky top-24">
                <h3 className="text-xl font-bold text-secondary-800 mb-4">Contact Agent</h3>
                <div className="space-y-4 mb-6">
                  <div className="flex items-center">
                    ...
                    <a href={`tel:${property.contact.phone}`} className="text-primary-600 hover:text-primary-700 font-semibold">
              ...
              {/* Property Info */}
              <div className="bg-white rounded-xl shadow-lg p-8">
                <h3 className="text-xl font-bold text-secondary-800 mb-4">Property Information</h3>
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">{property.floor} of {property.totalFloors}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-secondary-600">Balcony:</span>
