const RERA = () => {
  return (
    <section id="rera" className="bg-white section-padding">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl md:text-3xl font-bold mb-6">
                  Why Choose a RERA Registered Agent?
                </h3>
                <ul className="space-y-4 text-lg">
                  <li className="flex items-start">
                    <svg
                      className="w-6 h-6 text-green-300 mr-3 mt-1 flex-shrink-0"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
                      <path
                  ...
                  <li className="flex items-start">
                    ...
                    <span>Legal compliance and consumer protection</span>
                  </li>
                  <li className="flex items-start">
                    <svg
                      className="w-6 h-6 text-green-300 mr-3 mt-1 flex-shrink-0"
                  ...
                  <li className="flex items-start">
                    ...
                    <span>Dispute resolution and grievance redressal</span>
                  </li>
                </ul>
              </div>

              <div className="bg-white rounded-xl p-8 text-secondary-800">
                <div className="text-center mb-6">
                  ...
                  <p className="text-secondary-600">
                    Verified and Active Registration
                  </p>
                </div>
                ...
                <div className="mt-6 text-center">
                  ...
                  >
                    Verify on Official RERA Kerala Website
                  </a>
                </div>
              </div>
            </div>
